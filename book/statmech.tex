...
ensembles have $T_{c}=8.4256$ and $6.8801$. Most of that gap is the excess
chy-degrees, a regular layer having $\ave{\kbar}=\ave{\kappa}-1$ where a Poisson
one is its own excess. The cross term is the rest, and it is not a small
correction: deleting it from the regular case moves $T_{c}$ from $6.8801$ to
$5.2951$, a further $23$ per cent. It is one term, and it is easy to drop.
