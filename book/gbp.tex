...
Data from
\code{statmech/probe/gbp\_cliques.py}; plotted by \code{figs/overlap.py}.}
\label{fig:gbp}
\end{figure}
...
and in neighbourhood density alike. Data from \code{statmech/probe/gbp\_real.py}; plotted
