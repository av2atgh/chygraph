...
Equation~\eqref{eq:bethe} is this same expression on one particular family, $c=1$
on every complex and $1-k$ on every node, so the two schemes compared below
differ in their $c_{R}$ and in nothing else.
