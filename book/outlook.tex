...
Fourteen chapters is a long way from the preface's claim, which was that giving
...
calculation at $m=0$ and reach both thresholds --- Mulet's $c_{q}$ to a tenth of
...
machinery would carry it --- Eq.~\eqref{eq:sigma} is a reweighting of
