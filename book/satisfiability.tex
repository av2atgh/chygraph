...
Satisfiability is the model here that most needs what this book does not do. It
is included because the mapping is exact, because $2$-SAT comes out right, and
because it fails in the same way Chapter~\ref{ch:hittingset} fails --- which
bears on applying the method elsewhere.
