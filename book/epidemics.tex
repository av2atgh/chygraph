...
This chapter applies the two before it. An epidemic is
...
structure alone gives continuous transitions is untouched by this, and the two
are easily confused, so: within the percolation
...
\paragraph{What replaces it.} The tensor cannot be used, so what follows is the
simplest self-consistent equation that keeps the mechanism. Take a population with two kinds of connection: Poisson-many pairwise
