...
% Chapter 17 tests the Ising-only result of Chs. 14-16 against a hard-constraint
% model, on the same three classes and through the same solver.
\include{covertriangles}
