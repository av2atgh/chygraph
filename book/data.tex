...
chapters will work on your data, so it comes before the theory rather than
after.
...
One rule of thumb, with the evidence for it in Sec.~\ref{sec:promoting}: \textbf{if you have the group data, use it. Do
...
one to expect: the obstruction that
