...
The question is where. The argument follows in words before any algebra; the
whole book generalises it.
...
all three appear now on the same small graph, so the family resemblance is
visible.
...
in hand is wrong. This book flags every place they fire.
