...
combinations of variables are cheap. Five of the models that run through the
book are introduced here, and all five appear now on the same small graph, so
the family resemblance is visible. For the wider map --- spin models, $k$-core percolation, epidemic
...
All five are a variable at every node, an energy summing local terms, and a
