...
--- a \emph{leaf}. Its single link must be covered, and covering it at the leaf
can never be better than covering it at the neighbour, since the neighbour may
cover other links too. So there is always a minimum cover that takes the
...
\citep{bauer2001}. When it consumes the whole graph it has found a minimum
cover and \emph{proved} it minimum. When it stalls, what is left is called the
