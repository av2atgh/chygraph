...
Before any approximation there is something to be had for nothing. Some
variables are decided by their surroundings alone, and a variable that is
decided does not have to be computed: fix it, delete it, and put the question
again to what remains. It is worth doing this first, because what it leaves
behind is what everything after it has to work on.
...
None of that was a fact about vertex cover. Each model of
Sec.~\ref{sec:models} has variables its surroundings decide for it, and where
one is decided the recipe is the same: fix it, delete it, delete whatever
fixing it consumes, and ask again of what is left. Run to a fixed point the
procedure either empties the object or stalls, and what it stalls on is the
core. Three chapters use it, on three models and three kinds of object.
...
What survives the stripping earns a name and a symbol, because the book
measures it repeatedly. Write
\[
