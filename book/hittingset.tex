...
none is wasted, so the counting bound is saturated exactly. \code{softfield.\allowbreak regular\_\allowbreak field} is the closed form and \code{softfield.\allowbreak HittingSetBP.\allowbreak sweep} the population dynamics it is checked against.
