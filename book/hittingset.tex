...
\paragraph{A graph} is where the two problems coincide. At cardinality two,
...
\paragraph{A hypergraph} is the structure this chapter was written for, and
...
\paragraph{A multiplex network} is a graph as far as this chapter can tell.
Every layer is a link layer, hitting a link is covering it, and what is being
...
\paragraph{Interacting graphs and hypergraphs} is where this chapter's two
partitions visibly come apart, and it is the only structure that shows it. For
...
\paragraph{A clustered graph} is the only one of the five whose layer list is
mixed by construction --- links at cardinality two, triangles at three --- and so
the only row whose instability is not $e$. It sits at $3.28$ neighbours per node
