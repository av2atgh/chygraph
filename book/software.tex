...
Fig.~\ref{fig:hrg}, and the six measurements of Part~IV --- the cavity method on
...
Figs.~\ref{fig:corebonds} and~\ref{fig:coremeta}, the cost comparison of
Table~\ref{tab:vs}, and the leaf removal of Table~\ref{tab:leafclasses}. Those
eleven are the only places
