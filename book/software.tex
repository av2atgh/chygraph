...
from them rather than recomputed. \code{examples/}
...
Sec.~\ref{sec:unanimity} shows. A function that cannot be used incorrectly
does more than a note in its documentation would.
...
\ref{tab:colwindow} & the window, and where it closes & \code{figs/\allowbreak colouring.\allowbreak py:\allowbreak check\_\allowbreak window\_\allowbreak closes} & same file\\
