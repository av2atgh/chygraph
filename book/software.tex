...
Fig.~\ref{fig:hrg}, and the seven measurements of Part~IV --- the cavity method on
...
Fig.~\ref{fig:coretransition}. Those ten are the only places
...
--- & the cavity recursion on a chygraph & \code{probe/\allowbreak cavity\_\allowbreak clique.\allowbreak Chygraph\allowbreak BP} & \code{validate} in that file\\
\eqref{eq:branching} & the incidence branching & \code{probe/\allowbreak karrer\_\allowbreak core\_\allowbreak sweep.\allowbreak py} & \code{check\_\allowbreak core\_\allowbreak transition}\\
\eqref{eq:corea} & the pruning fixed point & \code{probe/\allowbreak karrer\_\allowbreak core\_\allowbreak sweep.\allowbreak core\_\allowbreak closed\_\allowbreak form} & \code{check\_\allowbreak closed\_\allowbreak form}\\
\eqref{eq:corefrac} & the core fraction & \code{probe/\allowbreak karrer\_\allowbreak core\_\allowbreak sweep.\allowbreak core\_\allowbreak closed\_\allowbreak form} & \code{check\_\allowbreak closed\_\allowbreak form}\\
\end{longtable}
}
