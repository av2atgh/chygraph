...
\citep{joslyn2017}. Their construction, in the language this book uses
...
Here is the sentence the rest of the book runs on. Every recursion in
Chapters~\ref{ch:percolation} to~\ref{ch:overlap} formalises it.
...
What the definitions buy. Each structure below is obtained by writing down its layers and their
