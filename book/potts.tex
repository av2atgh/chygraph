...
problem, vertex cover, colouring and satisfiability. They have been presented as
two subjects sharing a method. The correspondence this chapter proves is new here; Fortuin and
Kasteleyn's identity is not \citep{fortuin1972}. What is new is that
it holds complex by complex on a chygraph, and the transmission factor that
makes it do so is first computed in Sec.~\ref{sec:transmission}.

They are one subject: the
