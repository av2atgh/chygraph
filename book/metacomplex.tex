...
\paragraph{Phase transition in the Karrer--Newman ensemble.} All $40$ cyclic
families are Karrer--Newman, and Sec.~\ref{sec:coretransition} locates the cause
in the ensemble's parameters. Following an
