...
against a standard error of about $0.004$. Threshold and amplitude both, so
the right-hand panel of Fig.~\ref{fig:coretransition} is a finite-size check on
a curve that is known rather than the evidence that there is one.
