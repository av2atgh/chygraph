...
networks were trees. It is the trick that makes the subject work. If a network has no short loops, then cutting one node out of it
...
but a hierarchy of them. The last technical
...
the argument in the running text is meant to be followed without them. The book has a great many
pictures: nearly every idea here is about which things are grouped with which, and that is a fact about a drawing before it is a
...
set problem, vertex cover, colouring, satisfiability, and the treatment of
...
nobody has computed before. All of the results can be reproduced from two
software packages. Every number the book computes comes out of them,
...
\item A core-percolation transition on the Karrer--Newman ensemble,
  Sec.~\ref{sec:coretransition}.
\end{itemize}
