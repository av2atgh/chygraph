...
Chapter~\ref{ch:chygraphs} and Part~II draw on published work
\citep{vazquez2023pre,vazquez2024comnet}.
...
are checked here against the published thresholds, which the last section of
each chapter then computes rather than quotes. All of them can be reproduced
