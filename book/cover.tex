...
\paragraph{A hypergraph} is one layer of cardinality $c$. At $c\ge3$
Eq.~\eqref{eq:factored} removes the core-free branch, so there is no threshold
...
$c=3$. One layer above cardinality two is enough for Eq.~\eqref{eq:factored},
