...
Three things in this chapter are one thing. None of the three is new ---
leaf removal is Ref.~\citep{bauer2001}'s, the core and its transition
Ref.~\citep{liu2012}'s --- but the identification of all three at one point, and
everything above cardinality two, is first done here.
...
Ref.~\citep{liu2012}; what follows carries it to complexes. The letters here are
this book's: $\psi$ and $\xi$ are written $\lambda$ and $\kappa$ in that paper,
which are spoken for elsewhere in this book --- $\lambda$ is Chapter~\ref{ch:giant}'s
Perron root and $\kappa$ is the chy-degree throughout.
