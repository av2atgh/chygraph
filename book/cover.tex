...
the rule gets stuck on --- the core --- by a cavity calculation carrying three
states rather than one, since a node may be settled in either of two ways or in
neither. Sections~\ref{sec:hrg} and~\ref{sec:realcore} then put the predictions
