...
$P_{C}(\chi)$ under the leaf removal of this chapter --- take a chy-degree-one
atom together with the complex holding it, and $P_{C}$ is the share that
survives --- against chy-degree, for pure clique networks. At cardinality two there is a
