...
measurement, $P_{C}(\mathrm{VC},\mathrm{G})$. \emph{Eq.~\eqref{eq:core} on its
cliques} is the prediction, $P_{C}(\mathrm{VC},\chi)$, evaluated on the
...
graph, $P_{C}(\mathrm{VC},\chi)$ from Eq.~\eqref{eq:core} on that graph's own
