...
\code{cover.CliqueCover.tau} and the map is \code{cover.CliqueCover.solve},
...
\code{core.CorePercolation.solve}, which iterates monotonically from zero
...
\code{core.CorePercolation.has\_core\_free\_branch}, and it returns true exactly
...
over $\ave{k}\le1$. Data from \code{statmech/probe/prediction4.py}; plotted by
\code{figs/cover.py}.}
\label{fig:hrg}
\end{figure}
...
\code{figs/cover.py:table\_real\_core} from
\code{statmech/probe/real\_core.py}.}
\label{tab:realcore}
\end{table}
