...
Three things in this chapter are one thing.

An \emph{algorithm}, leaf removal, which sometimes solves minimum vertex cover
exactly and sometimes gets stuck. A \emph{structure}, the core, which is what it
gets stuck on, and which has a percolation transition of its own at mean degree
$e$. And the \emph{instability} of Chapter~\ref{ch:hittingset}'s hard-field map,
